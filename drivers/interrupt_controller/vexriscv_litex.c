...
#define IRQ_MASK		DT_VEXRISCV_INTC0_BC0_BASE_ADDRESS_0
#define IRQ_PENDING		DT_VEXRISCV_INTC0_BC0_BASE_ADDRESS_1
...
static void vexriscv_litex_irq_handler(void *device)
{
	...
	if (irqs & (1 << DT_LITEX_TIMER0_E0002800_IRQ_0)) {
		ite = &_sw_isr_table[DT_LITEX_TIMER0_E0002800_IRQ_0];
		ite->isr(ite->arg);
	}
#endif

#ifdef CONFIG_UART_INTERRUPT_DRIVEN
	if (irqs & (1 << DT_LITEX_UART0_E0001800_IRQ_0)) {
		ite = &_sw_isr_table[DT_LITEX_UART0_E0001800_IRQ_0];
		ite->isr(ite->arg);
	}
#endif
}
